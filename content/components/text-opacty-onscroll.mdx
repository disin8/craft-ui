...
description: A component to reveal a text on scroll
---

import {
  DemoFallback,
  TextOpacityOnScrollDemo
} from './demos'

A component to reveal a text on scroll
...
<TypeTable
  type={{
    byChars: {
      type: 'boolean',
      description: 'Wether to reveal a text by chars or by words',
      default: 'false',
    },
  }}
/>
